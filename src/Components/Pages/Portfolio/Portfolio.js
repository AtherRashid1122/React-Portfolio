...
//                         <img src={portfolioimage} className="logo" />
//                         <img src={dotsimage} className="image_design" />
//                     </div>
//                 </div>
...
//                                 Mark
//                             </h2>
//                             <h2 style={{ color: 'white', fontFamily: 'Poppins', width: '100%', fontSize: '60px', marginTop: ' -60px', fontWeight: 'bold' }}>
//                                 Reccardo
//                             </h2>
//                         </div>
//                     </div>
//                     <div className="About_us_contentimg"></div>
//                 </div>
//             </section>
